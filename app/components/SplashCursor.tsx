...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    function generateColor(): ColorRGB {
      // Very subtle brand colors (mint / cream), low intensity
      const mint: ColorRGB = { r: 0.72, g: 1.0, b: 0.82 }; // approx #B8FFD0
      const cream: ColorRGB = { r: 1.0, g: 0.97, b: 0.79 }; // approx #FFF6C9
      const t = Math.random();
      const r = mint.r * t + cream.r * (1.0 - t);
      const g = mint.g * t + cream.g * (1.0 - t);
      const b = mint.b * t + cream.b * (1.0 - t);
