...
`;
    ...
    class ShaderPass {
      ...
      constructor(props: Record<string, unknown>) {
        this.props = props || {};
        this.uniforms = (this.props.material as { uniforms: Uniforms } | undefined)
          ?.uniforms;
      }
      init(...args: unknown[]) {
    ...
    class Advection extends ShaderPass {
      ...
      constructor(simProps: Record<string, unknown>) {
        ...
        this.uniforms = (
          this.props.material as { uniforms: Uniforms }
        ).uniforms;
        this.init();
      }
      createBoundary() {
      ...
      update(...args: unknown[]) {
        const { dt, isBounce, BFECC } = (args[0] || {}) as Record<string, unknown>;
    ...
    class ExternalForce extends ShaderPass {
      ...
      init(...simArgs: unknown[]) {
        super.init();
        const simProps = (simArgs[0] || {}) as Record<string, unknown>;
      ...
      update(...args: unknown[]) {
        ...
        uniforms.force.value = new THREE.Vector2(forceX, forceY);
        uniforms.center.value = new THREE.Vector2(centerX, centerY);
        uniforms.scale.value = new THREE.Vector2(cursorSize, cursorSize);
        super.update();
      }
    }
    ...
    class Viscous extends ShaderPass {
      ...
      update(...args: unknown[]) {
        const { viscous, iterations, dt } = (args[0] || {}) as Record<string, unknown>;
        ...
        const iter = (iterations as number) ?? 0;
        for (let i = 0; i < iter; i++) {
          ...
          this.props.output = fbo_out_prop;
          if (typeof dt === "number") this.uniforms!.dt.value = dt;
          super.update();
          fbo_out = fbo_out_prop as THREE.WebGLRenderTarget;
        }
        return fbo_out;
      }
    }
    ...
    class WebGLManager implements LiquidEtherWebGL {
      ...
      constructor(props: WebGLManagerProps) {
        ...
        this.autoDriver = new AutoDriver(
          Mouse,
          this as unknown as WebGLManager,
          {
